...
//Code Here
let evenNumbers  = mixedNumbers.filter(e => e % 2 === 0 ? true : false);
...
let ordersTotal = orders.map((e) => e.price * (1+e.tax));
...
let bobsTotal = purchases.filter(e => e.owner === "Bob").reduce((t,e) => t+e.price,0)
